...
public class ImageWaterMark
{
        ...
        try
        {
            ...
            switch (wmtType)
            {
                ...
                case WaterMarkType.TextMark:
                    ...
                    addWatermarkText(g, sWaterMarkContent, "WM_BOTTOM_RIGHT",
        ...
        string _watermarkPosition, int _width, int _height)
    {
        ...
        var sizes = new int[] { 32, 30, 28, 26, 24, 22, 20, 18, 16, 14, 12, 10, 8, 6, 4 };
        ...
        // floatBmp.Save("d:WebSiteDIGITALKMttt.jpg");
...
 
        ...
        string _watermarkPosition, int _width, int _height)
    {
        ...
        addWatermarkImage(picture, watermark, _watermarkPosition, _width,
        ...
        int ThumbnailImageWidth)
    {
        ...
        var sExt = SourceImagePath.Substring(
